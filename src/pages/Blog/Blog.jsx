...
const Blog = () => {
    return (
        <Container className='mx-auto m-8 p-4'>
            <div className='mt-8'>
                <div className=''>
                    <h2 className=''>1.Tell us the differences between uncontrolled and controlled components </h2>
                    <h3 className=''>
                ...
                <div className=''>
                    <h2 className=''>2.How to validate React props using PropTypes?</h2>
                    <h3 className='' >Ans:
                ...
                <div className=''>
                    <h2 className=' '>3.Tell us the difference between nodejs and express js.</h2>
                    <h3 className=''>Ans:
                ...
                <div className=''>
                    <h2 className=''>4.What is a custom hook, and why will you create a custom hook?</h2>
                    <h3 className=''>Ans:
